...
async function create(req, res, next){
    ...
    let user = new User({
        name:name, lastName:lastName, email:email, password:passwordHash, salt:salt, role:role
    }); 
...
function replace(req, res, next){
    ...
    let user = new Object({
        _name:name, _lastName:lastName, _email:email, _password:password, _role:role
    });
